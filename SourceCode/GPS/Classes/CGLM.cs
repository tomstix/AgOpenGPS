...
namespace AgOpenGPS
{
    public static class DanielP
    {
        ...
        public static void CalculateRoundedCorner(this List<vec2> Points, double Radius, double Radius2, bool Loop, double MaxAngle, CancellationToken ct, int Count1 = 0, int Count2 = int.MaxValue)
        {
